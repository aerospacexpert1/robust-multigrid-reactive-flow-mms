#!/usr/bin/env python3
"""Compute matched 1/2/4/16-thread scaling for FINALVOL2."""
...
DEFAULT_INPUT=ROOT/"RMT_FINALVOL2_campaign_summary.csv"
DEFAULT_OUTPUT=ROOT/"RMT_FINALVOL2_scaling_summary.csv"
