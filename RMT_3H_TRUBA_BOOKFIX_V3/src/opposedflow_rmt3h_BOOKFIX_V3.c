// BOOKFIX_V3_GENERATED: Martynenko-style index-mapped pressure RMT; legacy source preserved separately.
...
int main(int argc, char **argv) {
    ...
    printf("RMT_BOOK_DIAGNOSTICS levelsX=%d levelsY=%d full_accepts=%lld backtracks=%lld rejects=%lld last_omega=%.17g point_updates=%lld\n",
